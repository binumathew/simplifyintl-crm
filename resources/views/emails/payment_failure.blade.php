								...
								<div style="font-size: 14px; line-height: 21px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #000000;">
									<p style="text-align: center; margin: 0;">
										...
										<span style="font-size: 16px;">
											<p><strong>Subsription failure details</strong></p>	Customer Name : {{ $data->name }}<br/>
											Contact Number : {{ $data->phone }}<br/>
											Email : {{ $data->email }}<br/>
											Plan name : {{ $data->plan }}<br/>
											Plan amount : {{ $data->sell_price }}<br/>
											Date and time of attempt : {{ $data->attempt }}<br/>
										</span>
									</p>
									Best Regards,<br />
