							...
							<div style="font-size: 14px; line-height: 21px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #000000;">
								<p style="text-align: center; margin: 0;">
									...
									<span style="font-size: 16px;"> 
										<p>									
											It seems you have used some chargeable premium services above your standard allowed Bundle Plan on your {{ $data->phone }}. If you want to continue using such services please inform customer service to avoid any service break down as there is existing credit limit on this service.
											For details please check your usage and for add-on plans contact customer services. 
										</p>																		
     								</span>
								</p>
