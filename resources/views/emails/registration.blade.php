								...
								<div style="font-size: 14px; line-height: 21px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #000000;">
									<p style="text-align: center; margin: 0;">
										...
										<span style="font-size: 16px;">
											You have successfully registered account in {{ config('settings.app_name') }}
											<p>username : 
												<strong>{{$data->email}}</strong>
											</p>											
											<p>Password : <strong>{{$data->password}}</strong></p>	
											<p>PromoCode : <strong>{{$data->promocode}}</strong></p>
											<br/>											
											Please login with following link:
											<div align="center" class="button-container" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
												<a href="{{url('/')}}" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #e4572e; border-radius: 15px; -webkit-border-radius: 15px; -moz-border-radius: 15px; width: auto; width: auto; border-top: 1px solid #fc7318; border-right: 1px solid #fc7318; border-bottom: 1px solid #fc7318; border-left: 1px solid #fc7318; padding-top: 4px; padding-bottom: 4px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank">
