								...
								<table id="contacttable" class="display responsive no-wrap" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr id="{{$i}}">
											...
											<td>
												<a data-toggle="tooltip" title="Edit"  href="{{url('/edit-plan',$plan->id)}}" class="fa fa-pencil-square-o editbtn"></a>
												<a data-toggle="tooltip" title="Delete" href="#" class="fa fa-trash-o cancelbtn delete_contact" data-plan_id="{{$plan->id}}" ></a>										
											</td>
										</tr>
										<?php 
										$i++; ?>
