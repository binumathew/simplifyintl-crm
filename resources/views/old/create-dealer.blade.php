					...
					<div class="Paymentsbg ctablebg clearfix">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								<div class="popTbox">
									<i>State</i>
									<input type="text" id="usr_updt_state" name="state">
								</div>
							</div>	
							<div class="col-md-6 col-sm-6">
								<div class="popTbox">
							...
							<!-- <div class="col-md-6 col-sm-6">
								<div class="popTbox">
									<i>Nationality</i>
									<input type="text" name="nationality" value="GB" class="input_disabled">
								</div>
							</div>	 -->										
						</div>
						...
						<!-- <div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="popTbox">
									<i>Country ID</i>
									<input type="text" name="country_id"  value="76" class="input_disabled">
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-6">
								<div class="popTbox">
									<i>Language</i>
									<input type="text" name="language" value="eng"  class="input_disabled">
								</div>
							</div>													
						</div> -->					
					</div>
