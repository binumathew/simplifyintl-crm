...
@section('content')
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
                    ...
                    <div class="Unavbg">
                        <div id="msg_" style="display:none;" class="alert alert-success"></div>
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <ul class="EAbtnbg">
                                    <li>
                                    <button type="button" id="comm-generate" class="btn btn-primary">Generate</button>
                                    </li>
                                </ul>
                            </div>
					...
					<div class="Paymentsbg ctablebg clearfix">
						...
						<div class="row">
							<div class="col-md-12">
                            <table id="report-order-table" class="table table-condensed" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Promocode</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="new-autorecharge-form" method="POST">
                        <div class="form-group">
                            ...
                            <select id="dealer" class="form-control" name="dealer">
                                @foreach($dealers as $dealer)
                                    <option value="{{$dealer->user_id}}">{{$dealer->first_name}} {{$dealer->last_name}} ({{$dealer->promocode}})</option>
                                @endforeach
                            </select>
                        ...
                        <input type="hidden" name="dealer_type" value="staff">                                  
	...
	$(document).ready(function(){
        ...
        $(document).on("click", '#comm-generate', function (){
                //$('#loadingsign').show();
                $.ajax({
                    headers: {
                    ...
                    url: base_url+'/comm-staff-generate',
                    success: function(response){ 
                        //$('#loadingsign').hide();
                        if(response.status == "success"){
                            $('#msg_').text(response.message);
                            $('#msg_').show();
                            orderTable.draw();
                        }
                    }
