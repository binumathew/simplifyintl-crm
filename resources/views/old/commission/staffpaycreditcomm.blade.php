...
@section('content')
	<div class="Cwrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="Cleftpart">
						<h1>Staff PayCredit Commission</h1>						
					</div>
					<div class="Unavbg">
						<div class="row">
							...
							<div class="col-md-8 col-sm-7">
								<ul class="Ulinenav clearfix">
									<li class="active"><a href="">Staff PayCredit Commission</a></li>
							...
							<div class="col-md-4 col-sm-5">
								<ul class="EAbtnbg">
									...
									<li><a href="add-staff-paycredit-commission">ADD&nbsp;STAFF PAYCREDIT COMMISSION</a></li>
								</ul>
							</div>					
						</div>
					</div>   
	...
	$(document).ready(function(){
		...
		var orderTable = $('#contacttable').DataTable({
            ...
            dom :'Blfrtip',
            ajax: {
                url: 'staff-paycredit-commission-list',
                data: function (d) {
            ...
            columns: [
                ...
                // {"data": function(data){
                // var route = "{{URL::to('add-staff-port-commission/'.Crypt::encrypt('"+data.role_id+"'))}}";
                // var html = '<a data-toggle="tooltip" title="Edit"  href="'+route+'" class="fa fa-pencil-square-o editbtn"></a>';
                // return  html;
                // }, "name": "action"},
            ],
            buttons: [
