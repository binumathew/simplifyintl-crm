...
@section('content')
	<div class="Cwrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div class="Cleftpart">
						<h1>Staff Porting Commission</h1>						
					</div>
					<div class="Unavbg">
						<div class="row">
							...
							<div class="col-md-8 col-sm-7">
								<ul class="Ulinenav clearfix">
									<li class="active"><a href="">Staff Porting Commission</a></li>
							...
							<div class="col-md-4 col-sm-5">
								<ul class="EAbtnbg">
									...
									<li><a href="add-staff-port-commission">ADD&nbsp;STAFF PORTING COMMISSION</a></li>
								</ul>
							</div>					
						</div>
					</div>   
	...
	$(document).ready(function(){
		...
		var orderTable = $('#contacttable').DataTable({
            ...
            dom :'Blfrtip',
            ajax: {
                url: 'staff-port-commission-list',
                data: function (d) {
