...
<div class="Cwrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-10">
				<div class="Cleftpart">
					<h1>Update Plan Commission</h1>
				</div>
				<form action="{{ url('save-plancommission') }}" method="post" id="commplan-form">			<input type="hidden" name="id" value="{{ $plandetails[0]->plan_type.'-'.$plandetails[0]->plan_id }}">		
					@csrf
					<div class="Paymentsbg ctablebg clearfix">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="addbtnsbg">
									<a class="cancel_btn" href="{{ url('comm-planlist') }}">CANCEL</a>
