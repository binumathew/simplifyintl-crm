...
<div class="Cwrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<div class="Cleftpart">
					<h1>Add Staff Porting Commission</h1>
				</div>
				...
				<form action="{{ url('save-staff-port-commission') }}" method="post" id="form">
					{{csrf_field()}}
					...
					<div class="Paymentsbg ctablebg clearfix">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="addbtnsbg">
									<a class="cancel_btn" href="{{ url('comm-staff-portlist') }}">CANCEL</a>
