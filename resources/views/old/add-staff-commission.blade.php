					...
					<div class="Paymentsbg ctablebg clearfix">
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								<div class="popTbox">
									...
									<input type="text" class="form-control" aria-describedby="basic-addon1" name="target_from" value="">
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								<div class="popTbox">
									<i>Commission Rate</i>
									<input type="text" class="form-control customdate" name="commission_rate" id="commission_rate"  value="">
								</div>
							</div>
