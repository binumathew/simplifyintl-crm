                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Define Dealer Commission</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Define Dealer Commission</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <div class="card m-b-20">
                            ...
                            <div class="card-body right-nav">
                                ...
                                <ul>
                                    <li><a href="{{ url('/comm-plan-dealer') }}" class="selected">Dealer Commissions List</a></li>  
                                </ul>                            
                        ...
                        <div class="card m-b-20">
                            <div class="card-body">
                                <div class="order-search">
                                    <form action="{{ url('save-dealercommission') }}" id="save-dealercommission-form" method="POST">
                                        @csrf
                                    <h5>{{ (!empty($plan)) ? 'Edit' : 'Define' }} Dealer Commission</h5>
                                                ...
                                                <div class="input-group">
                                                   <select class="form-control" name="dealer_id" id="dealerId" required>
                                                    ...
                                                    @foreach ($dealer as $usr)
                                                        <option {{ (!empty($plan) && $plan[0]->user_id == $usr->id)?'selected':'' }} value="{{Crypt::encrypt($usr->id)}}">{{$usr->first_name.'-'.$usr->promocode}}</option>
                                                    @endforeach
                                                </select>
                                                </div>
                                                <span></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="submit" id="dealercommBtn" class="btn btn-primary ">{{ (!empty($plan)) ? 'Update' : 'Define' }} Dealer Commission</button>
