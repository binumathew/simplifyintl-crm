        ...
        <script src="{{ asset('public/plugins/flot-chart/jquery.flot.min.js') }}"></script>
        <script src="{{ asset('public/plugins/flot-chart/jquery.flot.time.js') }}"></script>
        <script src="{{ asset('public/plugins/flot-chart/jquery.flot.tooltip.min.js') }}"></script>
        <script src="{{ asset('public/plugins/flot-chart/jquery.flot.resize.js') }}"></script>
        <script src="{{ asset('public/plugins/flot-chart/jquery.flot.pie.js') }}"></script>
        <script src="{{ asset('public/plugins/flot-chart/jquery.flot.selection.js') }}"></script>
        <script src="{{ asset('public/plugins/flot-chart/jquery.flot.stack.js') }}"></script>
        <script src="{{ asset('public/plugins/flot-chart/curvedLines.js') }}"></script>
        <script src="{{ asset('public/plugins/flot-chart/jquery.flot.crosshair.js') }}"></script>
        <script src="{{ asset('public/plugins/highcharts.js') }}"></script>
        <script src="{{ asset('public/js/bootstrap4-toggle.min.js') }}"></script>
        <script src="{{ asset('public/js/settings.js') }}"></script>
        <script src="{{ asset('public/js/support.js') }}"></script>
        <script src="{{ asset('public/js/commission.js') }}"></script>
